...
<head>
  ...
  <title><?php echo $this->collection['title'] ?> | Blog</title>
</head>
...
<body>
  ...
  <section class="page-banner">
    <div class="banner-container">
      <div class="left-box">
        ...
        <h1 class="banner-title"><?php echo $this->collection['title'] ?></h1>
        <p class="primary-font">
          <?php echo $this->collection['description']; ?>
        </p>
      </div>
    </div>
  </section>
  ...
  <div class="page-content">
    ...
    <div class="main-content">
      ...
      <?php endforeach;?>
      <input type="hidden" class="collection-slug" value="<?php echo $this->collection['slug']; ?>" >
  ...
  <script>
    let currentPage = 2;
    const collectionSlug = document.querySelector('.collection-slug').value;
    loadMoreButton.addEventListener('click', function() {
      const morePostsUrl = `${baseUrl}/collection/${collectionSlug}?page=${currentPage}`;
